...
export default async function CustomerLayout({ children }: { children: React.ReactNode }) {
  ...
  const nav: NavItem[] = [
    ...
    { section: "Beheren", sectionColor: colors.manage, href: "/dashboard/orders", label: "Mijn orders", icon: "Package" },
    { section: "Beheren", sectionColor: colors.manage, href: "/dashboard/links", label: "Mijn links", icon: "Link2" },
    { section: "Beheren", sectionColor: colors.manage, href: "/dashboard/renewals", label: "Verlengen", icon: "RefreshCw", badge: expiringCount },
